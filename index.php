    ...
    <body>
      ...
      <main>
            ...
            <div class="row">
                ...
                <div class="col-1-of-2">
                    <div class="composition">
                        ...
                        <!-- 300w or 1000w is to tell the browser the width of my image -->
                        <!-- with sizes property I can define which is shown in which screen size -->
                        <!-- vw = pixels width image / screen size  so example a phone 171px / 900px width image = 0.19vw -->
                        <!-- src in case the browser is old and don't have srcset -->
        ...
        <section class="section-stories">
            ...
            <div class="u-center-text u-margin-top-huge">
                <a href="./blog.php" class="btn-text btn-dark-green">Read all stories &rarr;</a>
            </div>
